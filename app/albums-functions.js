...
function reload_AlbumGrid() {
	...
	// 'selectedClass' to be defined by function call
...
function button_add_album() {
	...
	/* reload
	create_album_button += " <button id='reload' class='button radius small alert' type='button'>";
	create_album_button += " RELOAD</button>"; /* */
